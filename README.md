...
Note: You can easily switch between training a new model or loading the pre-trained weights (model\_digits.txt) by changing the do\_training boolean inside main().
